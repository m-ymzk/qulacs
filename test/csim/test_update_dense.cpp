...
#ifdef _USE_SIMD
TEST(UpdateTest, SingleDenseMatrixTestScalarAvx) {
    test_single_dense_matrix_gate(
        single_qubit_dense_matrix_gate_single_simd, 6);

#ifdef _OPENMP
    test_single_dense_matrix_gate(
        single_qubit_dense_matrix_gate_parallel_simd, 6);
#endif  //#ifdef _OPENMP
}
