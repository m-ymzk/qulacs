...
TEST(UpdateTest, CNOTGateSVE) {
    test_two_qubit_named_gate(1, "CNOTGateSVE", CNOT_gate_single_sve,
        get_eigen_matrix_full_qubit_CNOT);
    test_two_qubit_named_gate(4, "CNOTGateSVE", CNOT_gate_single_sve,
        get_eigen_matrix_full_qubit_CNOT);
    test_two_qubit_named_gate(6, "CNOTGateSVE", CNOT_gate_single_sve,
        get_eigen_matrix_full_qubit_CNOT);
#ifdef _OPENMP
    test_two_qubit_named_gate(1, "CNOTGateSVE", CNOT_gate_parallel_sve,
        get_eigen_matrix_full_qubit_CNOT);
    test_two_qubit_named_gate(4, "CNOTGateSVE", CNOT_gate_parallel_sve,
        get_eigen_matrix_full_qubit_CNOT);
    test_two_qubit_named_gate(6, "CNOTGateSVE", CNOT_gate_parallel_sve,
        get_eigen_matrix_full_qubit_CNOT);
#endif
}
#endif
