...
TEST(UpdateTest, SingleDiagonalMatrixTest) {
    ...
    test_single_diagonal_matrix_gate(
        single_qubit_diagonal_matrix_gate_single_unroll, 6);
#ifdef _OPENMP
    test_single_diagonal_matrix_gate(
        single_qubit_diagonal_matrix_gate_parallel_unroll, 6);
#endif
#ifdef _USE_SIMD
    test_single_diagonal_matrix_gate(
        single_qubit_diagonal_matrix_gate_single_simd, 6);
#ifdef _OPENMP
    test_single_diagonal_matrix_gate(
        single_qubit_diagonal_matrix_gate_parallel_simd, 6);
#endif
#endif
}
...
TEST(UpdateTest, SingleDiagonalMatrixTestSVE) {
    test_single_diagonal_matrix_gate(single_qubit_diagonal_matrix_gate_sve, 1);
    test_single_diagonal_matrix_gate(single_qubit_diagonal_matrix_gate_sve, 6);
}
