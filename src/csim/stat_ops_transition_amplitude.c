...
CTYPE transition_amplitude_multi_qubit_Pauli_operator_XZ_mask(
    ...
    ITYPE dim);
CTYPE transition_amplitude_multi_qubit_Pauli_operator_Z_mask(
    ITYPE phase_flip_mask, const CTYPE* state_bra, const CTYPE* state_ket,
    ITYPE dim);
